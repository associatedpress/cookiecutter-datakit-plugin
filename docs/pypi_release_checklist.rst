...
#. Edit the release on GitHub (e.g. https://github.com/associatedpress/cookiecutter-datakit-plugin/releases). Paste the release notes into the release's release page, and come up with a title for the release.
...
It assumes that you are using all features of Cookiecutter Datakit Plugin (as adapted from `cookiecutter pypackage`_
