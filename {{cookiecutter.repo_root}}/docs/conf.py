...
# -*- coding: utf-8 -*-
#
# {{ cookiecutter.repo_root }} documentation build configuration file, created by
...
html_theme_options = {
    ...
    'github_repo': '{{ cookiecutter.repo_root }}',
    'github_button': True,
    'fixed_sidebar': True,
...
htmlhelp_basename = '{{ cookiecutter.repo_root }}doc'
...
# [howto/manual]).
latex_documents = [
    ('index', '{{ cookiecutter.repo_root }}.tex',
